      ...
      <div className="announcement-marquee bg-[#1d638f] p-2">
        <div className="announcement-marquee-track">
          <p className="announcement-marquee-item text-center md:w-full">
            Attend the online information session for the Post Graduate Certificate in IB Education on 30<sup>th</sup> of May at 4PM IST by registering <a href="https://tinyurl.com/PGCIB-16526" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 font-bold">here</a>.
          </p>
          <p className="announcement-marquee-item text-center md:hidden" aria-hidden="true">
            Attend the online information session for the Post Graduate Certificate in IB Education on 30<sup>th</sup> of May at 4PM IST by registering <span className="underline underline-offset-4 font-bold">here</span>.
          </p>
        </div>
      </div>
    </nav>
