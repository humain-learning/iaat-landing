...
export const ForWho = () => {
    return (
        <div className="flex flex-col scroll-offset-target items-center" id='for-who'>
                ...
                <div className="w-full h-full bg-[#124477] px-5 py-2 flex items-center justify-center">
                    <img src='/assets/for-who-title.svg' className="object-contain h-full w-auto" />
                ...
                <div className="w-full h-full bg-[#124477] px-5 py-2 flex items-center justify-center">
                    <img src='/assets/elligibility-title.svg' className="object-contain h-full w-auto" />
                    <h1 className="font-normal text-white text-3xl px-5">
                        Elligibility
                    </h1>
                </div>
