...
export const Slide2 = () => {
    return (
        <div className="w-full h-full flex flex-col relative">
            <h1 className="text-lg xs:text-xl sm:text-2xl md:text-[2rem] mb-1 sm:mb-2 text-foreground px-3 xs:px-4 sm:px-5 py-3 xs:py-4 sm:py-5 text-start">
                    Post-Graduate Certificate in IB Education
            </h1>

            <div className='text-[#124578] text-base xs:text-lg sm:text-xl md:text-[1.5rem] px-3 xs:px-4 sm:px-5 py-3 xs:py-4 sm:py-5 text-start'>Dual Certificate</div>

            <div className='flex items-center p-3 xs:p-4 sm:p-5 text-start'>
            ...
            <br />
            <div className='flex items-center p-3 xs:p-4 sm:p-5 text-start z-10'>
